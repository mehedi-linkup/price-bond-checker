        ...
        <div class="sb-sidenav-menu">
            <div class="nav">
                <a class="nav-link" href="{{ route('dashboard') }}">
                    <div class="sb-nav-link-icon"><i class="far fa-tachometer-alt"></i></div>
                    Dashboard
                </a>
                <a class="nav-link" href="{{ route('price-winner') }}">
                    <div class="sb-nav-link-icon"><i class="far fa-trophy"></i></div>
                    Winner List
                </a>
                <a class="nav-link" href="{{ route('userbond') }}">
                    <div class="sb-nav-link-icon"><i class="far fa-shopping-basket"></i></div>
                    Purchase Bonds
                </a>
                ...
                <a class="nav-link" href="{{ route('sales') }}">
                    <div class="sb-nav-link-icon"><i class="far fa-donate"></i></div>
                    Sell Bonds
                </a>
                ...
                {{-- <a class="nav-link" href="{{ route('draw') }}">
                    <div class="sb-nav-link-icon"><i class="far fa-award"></i></div>
                    Draw Result
                </a> --}}
                <a class="nav-link {{ ($pageName == 'report-all' || $pageName == 'report-draw' ? 'active' : 'collapsed') }}" href="#" data-toggle="collapse" data-target="#collapseLayouts1" aria-expanded="false" aria-controls="collapseLayouts1">
                    <div class="sb-nav-link-icon"><i class="far fa-flag-checkered"></i></div>
                    Reports
                    <div class="sb-sidenav-collapse-arrow"><i class="far fa-angle-down"></i></div>
                </a>
                ...
                <a class="nav-link {{ ($pageName == 'lot' || $pageName == 'bond-series' || $pageName == 'price-list' || $pageName == 'client' || $pageName == 'source' || $pageName == 'draw' ? 'active' : 'collapsed') }}" href="#" data-toggle="collapse" data-target="#collapseLayouts2" aria-expanded="false" aria-controls="collapseLayouts2">
                    <div class="sb-nav-link-icon"><i class="far fa-cogs"></i></div>
                    Settings
                    <div class="sb-sidenav-collapse-arrow"><i class="far fa-angle-down"></i></div>
                </a>
                <div class="collapse {{ ($pageName == 'lot' || $pageName == 'bond-series' || $pageName == 'prize-list' || $pageName == 'client'|| $pageName == 'source' || $pageName == 'draw' ? 'show' : '') }}" id="collapseLayouts2" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('lot') }}">
                            <div class="sb-nav-link-icon"><i class="far fa-plus-circle"></i></div>
                            Add Lot
                        </a> 
                ...
                {{-- <a class="nav-link {{ ($pageName == 'content' || $pageName == 'service' || $pageName == 'category' || $pageName == 'subcategory' || $pageName == 'management' || $pageName == 'gallery' || $pageName == 'product' || $pageName == 'partner' ? 'active' : 'collapsed') }}" href="#" data-toggle="collapse" data-target="#collapseLayouts1" aria-expanded="false" aria-controls="collapseLayouts1">
                    <div class="sb-nav-link-icon"><i class="far fa-columns"></i></div>
                    Web Content
                    <div class="sb-sidenav-collapse-arrow"><i class="far fa-angle-down"></i></div>
                </a> --}}
                ...
                <a class="nav-link {{ ($pageName == 'profile' || $pageName == 'register') ? 'active' : 'collapsed' }} " href="#" data-toggle="collapse" data-target="#collapseLayouts3" aria-expanded="false" aria-controls="collapseLayouts3">
                    <div class="sb-nav-link-icon"><i class="far fa-users-cog"></i></div>
                    Authentication
                    <div class="sb-sidenav-collapse-arrow"><i class="far fa-angle-down"></i></div>
                </a>
